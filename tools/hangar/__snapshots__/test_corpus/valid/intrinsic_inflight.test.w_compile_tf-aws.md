# [intrinsic_inflight.test.w](../../../../../examples/tests/valid/intrinsic_inflight.test.w) | compile | tf-aws
...
//# sourceMappingURL=inflight.Example-1.cjs.map
```
  ...
  constructor($scope, $id) {
    ...
    class Example extends $stdlib.std.Resource {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.Example-1.cjs")({
...
const $APP = $PlatformManager.createApp({ outdir: $outdir, name: "intrinsic_inflight.test", rootConstruct: $Root, isTestEnvironment: $wing_is_test, entrypointDir: process.env['WING_SOURCE_DIR'], rootId: process.env['WING_ROOT_ID'] });
$APP.synth();
